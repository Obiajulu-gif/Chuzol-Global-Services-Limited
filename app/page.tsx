  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-8 z-10">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                  ...
                  <span className="text-yellow-400 animate-fade-in-right">Africa's</span>
                  <span className="block text-white">Exports</span>
                </h1>

                <p className="text-xl lg:text-2xl text-green-100 leading-relaxed max-w-2xl">
                  Connecting Africa's finest agricultural products, Agro Industrial Raw Material and Food ingredient to
                  global markets with uncompromising quality and reliable international shipping solutions.
                </p>
              </div>
      ...
      <section ref={productsRef} className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-green-100 text-green-800">Premium Quality</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">Featured Products</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover our premium selection of Nigerian agricultural products, carefully processed and packaged for
              global markets with guaranteed quality and authenticity.
            </p>
          </div>
      ...
      <section ref={servicesRef} className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-100 text-blue-800">Our Expertise</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">Our Services</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive solutions for agro-industrial raw materials from processing to global distribution with
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-purple-100 text-purple-800">Client Success</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">What Our Clients Say</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Trusted by businesses worldwide for our commitment to quality and exceptional service.
            </p>
          </div>
      ...
      <section className="py-16 bg-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Certified excellence in every aspect of our operations</p>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-green-100 max-w-3xl mx-auto leading-relaxed">
                Join our global network of partners and access premium Nigerian agricultural products with guaranteed
                quality and reliable delivery. Let's grow together.
              </p>
            </div>
      ...
      <div className="fixed bottom-4 right-4 flex flex-col space-y-2 md:hidden z-50">
        <Button size="sm" className="bg-green-600 hover:bg-green-700 rounded-full p-3 animate-bounce shadow-lg">
          <MessageCircle className="h-5 w-5" />
        </Button>
        <Button
          size="sm"
