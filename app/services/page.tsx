...
const services = [
  ...
  },
  {
    ...
    features: ["ISO certified processes", "Laboratory testing", "Traceability systems", "Continuous monitoring"],
    image: "/placeholder.svg?height=300&width=400",
  },
  {
    icon: <Leaf className="h-12 w-12 text-green-600" />,
    title: "Sustainable Sourcing",
    description: "Ethical sourcing practices supporting local farmers and sustainable agriculture.",
    features: [
  ...
  },
  {
    ...
    description: "Expert consultation on agricultural export processes and market entry strategies.",
    features: [
...
const processSteps = [
  {
    step: "01",
    title: "Sourcing",
    description: "We source premium quality raw materials directly from trusted farmers across Nigeria.",
    icon: <Leaf className="h-8 w-8 text-green-600" />,
  },
  {
    step: "02",
    title: "Processing",
    description: "Advanced processing techniques ensure optimal quality while preserving natural properties.",
    icon: <Factory className="h-8 w-8 text-green-600" />,
  },
  {
    step: "03",
    title: "Quality Control",
    description: "Rigorous testing and quality assurance at every stage of the production process.",
    icon: <Shield className="h-8 w-8 text-green-600" />,
  },
  {
    step: "04",
    title: "Packaging",
    description: "Professional packaging designed to maintain product integrity during transportation.",
    icon: <Package className="h-8 w-8 text-green-600" />,
  },
  {
    step: "05",
    title: "Export",
    description: "Efficient export processes with full documentation and logistics support.",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-r from-green-700 to-green-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Badge className="mb-4 bg-green-600 hover:bg-green-600 animate-bounce">Comprehensive Solutions</Badge>
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Our
              <span className="block text-yellow-400">Services</span>
            </h1>
            <p className="text-xl text-green-100 max-w-3xl mx-auto">
              End-to-end agricultural export services from sourcing to global delivery, ensuring quality and reliability
              at every step.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive services designed to meet all your agricultural export needs with excellence and
              reliability.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A systematic approach ensuring quality and efficiency from farm to global markets.
            </p>
          </div>
                ...
                <div key={index} className="text-center relative">
                  ...
                  {index < processSteps.length - 1 && (
                    <div className="hidden md:block absolute top-8 left-full w-full">
                      <ArrowRight className="h-6 w-6 text-green-600 mx-auto animate-pulse" />
                    </div>
                  )}
                </div>
              ))}
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose Chuzol Global?</h2>
            <p className="text-xl text-green-100 max-w-3xl mx-auto">
              Experience the difference of working with Nigeria's premier agricultural export company.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-green-100">
                Reliable delivery schedules with real-time tracking and updates throughout the shipping process.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-green-100">
                Unwavering commitment to quality with rigorous testing and quality assurance at every stage.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-green-100">
                Dedicated customer support team with deep expertise in agricultural exports and international trade.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Contact us today to discuss your agricultural export needs and discover how we can help your business grow.
          </p>
