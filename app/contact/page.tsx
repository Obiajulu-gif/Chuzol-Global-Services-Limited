...
const contactInfo = [
  ...
  },
  {
    ...
    title: "Phone Numbers",
    details: ["+234 123 456 7890", "+234 987 654 3210", "WhatsApp: +234 123 456 7890"],
  },
  {
      ...
      <section className="relative bg-gradient-to-r from-green-700 to-green-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Badge className="mb-4 bg-green-600 hover:bg-green-600 animate-pulse">Get in Touch</Badge>
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Contact
              <span className="block text-yellow-400">Us</span>
            </h1>
            <p className="text-xl text-green-100 max-w-3xl mx-auto">
              Ready to start your agricultural export journey? We're here to help you every step of the way.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Visit us at our head office in Lagos, Nigeria</CardDescription>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">What products do you export?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  We export a wide range of Nigerian agricultural products including bitter kola, shea butter, cashew
                  nuts, hibiscus flowers, tiger nuts, and many more premium quality products.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">
                  Minimum order quantities vary by product. Generally, we require a minimum of 1 ton for most products.
                  Contact us for specific requirements for your desired products.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Do you provide quality certificates?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Yes, we provide comprehensive quality certificates including certificates of origin, phytosanitary
                  certificates, and quality analysis reports for all our exports.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">
                  ...
                  mutually agreed payment methods. Terms are discussed based on order size and customer relationship.
                </p>
              </CardContent>
            </Card>
          </div>
