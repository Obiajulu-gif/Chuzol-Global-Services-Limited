  ...
  return (
		<footer className="bg-gray-900 text-white py-12">
				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
					<div>
						<h3 className="text-xl font-bold mb-4">
							Chuzol Global Service Limited
						</h3>
						<p className="text-gray-400 mb-4">
							Licensed by Nigeria Corporate Affairs Commission (CAC) - July 2024
						</p>
						<p className="text-gray-400">
							Your trusted partner for premium Nigerian agricultural exports.
						</p>
					</div>
					...
					<div>
						...
						<div className="space-y-3">
							...
							<div className="flex items-center space-x-2">
								...
								<span className="text-gray-400">chuzolglobal@gmail.com</span>
							</div>
							<div className="flex items-center space-x-2">
								<Phone className="h-4 w-4 text-green-500" />
								<span className="text-gray-400">+234 806 834 0120</span>
							</div>
            ...
            <p className="text-gray-400 text-center md:text-left">
              © {new Date().getFullYear()} Chuzol Global Service Limited. All rights reserved.
            </p>
